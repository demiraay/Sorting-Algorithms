...
Complexity analysis tables to complete (Table \ref{tab:resultscomplexity} and Table \ref{tab:spacecomplexity}):
    ...
    Comb sort & $\Omega()$        & $\Theta()$       & $O()$       \\
    Insertion sort     & $\Omega()$ & $\Theta()$ & $O()$ \\
    Shaker sort     & $\Omega()$        & $\Theta()$       & $O()$      \\ 
    Shell sort     &  $\Omega()$        & $\Theta()$       & $O()$      \\ 
    Bitonic sort     &  $\Omega()$        & $\Theta()$       & $O()$   \\\bottomrule
    \end{tabular}
    \end{table}
